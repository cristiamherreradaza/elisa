            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{ $p->user->name }}</a>
                        <div class="d-flex">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-muted font-weight-bold">{{ $p->categoria->nombre }}</span>
                            </div>
                        </div>
                    </div>
                    <!--end::Info-->
                    ...
                    @auth
                        ...
                        @if ($p->user_id == Auth::user()->id || Auth::user()->perfil == 'Administrador')
                            <div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="" data-placement="left"
                                data-original-title="Quick actions">
                                <a href="#" onclick="eliminaPublicacion('{{ $p->id }}');" class="btn btn-danger btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="pt-3">
                    <!--begin::Text-->
                    <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-6">{{ $p->contenido }}</p>
                    <!--end::Text-->
                    <!--begin::Image-->
                    @php
                        $imagen = App\Imagen::where('publicacion_id', $p->id)->first();
                    @endphp
                    <div class="bgi-no-repeat bgi-size-cover rounded min-h-295px"
                        style="background-image: url({{ asset("img_publicaciones/$imagen->imagen") }})"></div>
                    <!--end::Image-->
                    <!--begin::Action-->
                    <div class="pt-6">
