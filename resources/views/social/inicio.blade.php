                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <a href="#" onclick="categoria('todos')" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">INICIO</a>
                                    ...
                                    <div class="d-flex align-items-center mb-9 bg-light-success rounded p-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <a href="#" onclick="categoria('general')" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">GENERAL</a>
                                            <span class="text-muted font-weight-bold"></span>
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Lable-->
                                        <span class="font-weight-bolder text-success py-1 font-size-lg">+28%</span>
                                        <!--end::Lable-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <a href="#" onclick="categoria('desaparecidos')" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">DESAPARECIDOS</a>
                                            <span class="text-muted font-weight-bold"></span>
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Lable-->
                                    ...
                                    <div class="d-flex align-items-center bg-light-info rounded p-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <a href="#"  onclick="categoria('mascotas')"  class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">MASCOTAS</a>
                                            <span class="text-muted font-weight-bold"></span>
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Lable-->
