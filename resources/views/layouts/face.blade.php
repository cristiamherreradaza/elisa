...
<head>
    ...
    <script>
        (function(h,o,t,j,a,r){ h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)}; h._hjSettings={hjid:1070954,hjsv:6}; a=o.getElementsByTagName('head')[0]; r=o.createElement('script');r.async=1; r.src=t+h._hjSettings.hjid+j+h._hjSettings.hjsv; a.appendChild(r); })(window,document,'https://static.hotjar.com/c/hotjar-','.js?sv=');
    </script>
</head>
<!--end::Head-->
<!--begin::Body-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
        ...
        <a href="/metronic/demo4/index.html">
            <img alt="Logo" src="/metronic/theme/html/demo4/dist/assets/media/logos/logo-letter-3.png"
                                ...
                                <div id="kt_header_menu"
                                    ...
                                    <ul class="menu-nav">
                                        <li class="menu-item menu-item-active" aria-haspopup="true">
                                            <a href="/metronic/demo4/index.html" class="menu-link">
                                                ...
                                                <ul class="menu-subnav">
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/typography.html"
                                                                        class="menu-link">
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/buttons.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/button-group.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/dropdown.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/navs.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/tables.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/progress.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/modal.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/alerts.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/popover.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/bootstrap/tooltip.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/utilities.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/accordions.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/label.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/pulse.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/line-tabs.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/advance-navs.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/timeline.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/pagination.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/symbol.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/spinners.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/iconbox.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/callout.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/custom/ribbons.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/svg.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/custom-icons.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/flaticon.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/fontawesome5.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/lineawesome.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/icons/socicons.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/general.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/stacked.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/tabbed.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/draggable.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/tools.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/sticky.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/cards/stretched.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/lists.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/stats.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/charts.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/mixed.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/feeds.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/engage.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/base-tables.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/advance-tables.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/widgets/nav-panels.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/calendar/basic.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/calendar/list-view.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/calendar/google.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/calendar/external-events.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/calendar/background-events.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/charts/apexcharts.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/features/charts/amcharts/charts.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/features/charts/amcharts/stock-charts.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/features/charts/amcharts/maps.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/charts/flotcharts.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/charts/google-charts.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/maps/google-maps.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/maps/leaflet.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/maps/jqvmap.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right"
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/kanban-board.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/sticky-panels.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/blockui.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/perfect-scrollbar.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/treeview.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/bootstrap-notify.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/toastr.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/sweetalert2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/dual-listbox.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/session-timeout.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/idle-timer.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/features/miscellaneous/cropper.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="/metronic/demo4/builder.html" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                ...
                                                <ul class="menu-subnav">
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/base.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/input-group.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/checkbox.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/radio.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/switch.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/controls/option.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-datetimepicker.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-datepicker.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-timepicker.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-daterangepicker.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/tagify.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-touchspin.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-maxlength.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-switch.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-multipleselectsplitter.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/bootstrap-select.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/select2.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/typeahead.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/nouislider.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/form-repeater.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/ion-range-slider.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/input-mask.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/jquery-mask.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/autosize.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/clipboard.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/widgets/recaptcha.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/editors/tinymce.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item menu-item-submenu"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="menu-subnav">
                                                                                        <li class="menu-item"
                                                                                            aria-haspopup="true">
                                                                                            <a href="/metronic/demo4/crud/forms/editors/ckeditor-classic.html"
                                                                                                class="menu-link">
                                                                                                <i
                                                                                        ...
                                                                                        <li class="menu-item"
                                                                                            aria-haspopup="true">
                                                                                            <a href="/metronic/demo4/crud/forms/editors/ckeditor-inline.html"
                                                                                                class="menu-link">
                                                                                                <i
                                                                                                    class="menu-bullet menu-bullet-line">
                                                                                                    <span></span>
                                                                                        ...
                                                                                        <li class="menu-item"
                                                                                            aria-haspopup="true">
                                                                                            <a href="/metronic/demo4/crud/forms/editors/ckeditor-balloon.html"
                                                                                                class="menu-link">
                                                                                                <i
                                                                                                    class="menu-bullet menu-bullet-line">
                                                                                                    <span></span>
                                                                                        ...
                                                                                        <li class="menu-item"
                                                                                            aria-haspopup="true">
                                                                                            <a href="/metronic/demo4/crud/forms/editors/ckeditor-balloon-block.html"
                                                                                                class="menu-link">
                                                                                                <i
                                                                                                    class="menu-bullet menu-bullet-line">
                                                                                                    <span></span>
                                                                                        ...
                                                                                        <li class="menu-item"
                                                                                            aria-haspopup="true">
                                                                                            <a href="/metronic/demo4/crud/forms/editors/ckeditor-document.html"
                                                                                                class="menu-link">
                                                                                                <i
                                                                                                    class="menu-bullet menu-bullet-line">
                                                                                                    <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/editors/quill.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/editors/summernote.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/editors/bootstrap-markdown.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/layouts/default-forms.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/layouts/multi-column-forms.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/layouts/action-bars.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/layouts/sticky-action-bar.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/validation/states.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/validation/form-controls.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/forms/validation/form-widgets.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/data-local.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/data-json.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/data-ajax.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/html-table.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/local-sort.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/base/translation.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/record-selection.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/row-details.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/modal.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/column-rendering.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/column-width.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/advanced/vertical.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/child/data-local.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/child/data-ajax.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/api/methods.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/ktdatatable/api/events.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/basic/basic.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/basic/scrollable.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/basic/headers.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/basic/paginations.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/column-rendering.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/multiple-controls.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/column-visibility.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/row-callback.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/row-grouping.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/advanced/footer-callback.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/data-sources/html.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/data-sources/javascript.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/data-sources/ajax-client-side.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/data-sources/ajax-server-side.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/search-options/column-search.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/search-options/advanced-search.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/buttons.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/colreorder.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/keytable.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/responsive.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/rowgroup.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/rowreorder.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/scroller.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/crud/datatables/extensions/select.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-dot">
                                                                                        <span></span>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/crud/file-upload/image-input.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/crud/file-upload/dropzonejs.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/crud/file-upload/uppy.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/list-default.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/list-datatable.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/list-columns-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/list-columns-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/add-user.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/user/edit-user.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/profile/profile-1/overview.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/profile/profile-1/personal-information.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/profile/profile-1/account-information.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/profile/profile-1/change-password.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/profile/profile-1/email-settings.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/profile/profile-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/profile/profile-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/profile/profile-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/contacts/list-columns.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/contacts/list-datatable.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/contacts/view-contact.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/contacts/add-contact.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/contacts/edit-contact.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/chat/private.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/chat/group.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/chat/popup.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/list-columns-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/list-columns-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/list-columns-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/list-columns-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/list-datatable.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/view-project.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/add-project.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/projects/edit-project.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/home-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/home-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/faq-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/faq-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/faq-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/feedback.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/support-center/license.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/todo/tasks.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/todo/docs.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/todo/files.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/dashboard.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/statistics.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/calendar.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/library.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/teachers.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/school/students.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/student/dashboard.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/student/profile.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/student/calendar.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                            ...
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/student/classmates.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                                ...
                                                                <li class="menu-item menu-item-submenu"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="menu-subnav">
                                                                            <li class="menu-item" aria-haspopup="true">
                                                                                <a href="/metronic/demo4/custom/apps/education/class/dashboard.html"
                                                                                    class="menu-link">
                                                                                    <i
                                                                                        class="menu-bullet menu-bullet-line">
                                                                                        <span></span>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/dashboard.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/dashboard-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/dashboard-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/product-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/product-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/product-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/my-orders.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/order-details.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/shopping-cart.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/apps/ecommerce/checkout.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
                                                                            <span></span>
                                                                        </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="/metronic/demo4/custom/apps/inbox.html"
                                                            class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Shield-check.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="menu-subnav">
                                                    <ul class="menu-content">
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/pricing/pricing-1.html"
                                                                        class="menu-link">
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/pricing/pricing-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/pricing/pricing-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/pricing/pricing-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                        ...
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-5.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/wizard/wizard-6.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                        ...
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-5.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/invoices/invoice-6.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                        ...
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/login-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/login-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/login-3/signup.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/login-4/signup.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                        ...
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-5.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/login/classic/login-6.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                        ...
                                                        <li class="menu-item">
                                                            ...
                                                            <ul class="menu-inner">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-1.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-2.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-3.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-4.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-5.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="/metronic/demo4/custom/pages/error/error-6.html"
                                                                        class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
                                                                            <span></span>
                                                                        </i>
                                ...
                                <div
                                    ...
                                    <form>
                                        ...
                                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                            style="background-image: url(/metronic/theme/html/demo4/dist/assets/media/misc/bg-1.jpg)">
                                            <!--begin::Title-->
                                                ...
                                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"
                                                    ...
                                                    <div class="d-flex align-items-center mb-6">
                                                        ...
                                                        <div class="symbol symbol-40 symbol-light-success mr-5">
                                                            <span class="symbol-label">
                                                                <span class="svg-icon svg-icon-lg svg-icon-success">
                                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Design/Bucket.svg-->
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                        version="1.1">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item mr-3" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg">
                                        <span class="svg-icon svg-icon-xl">
                                            <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Media/Equalizer.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div class="row row-paddingless">
                                        ...
                                        <div class="col-6">
                                            <a href="#"
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Shopping/Euro.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="col-6">
                                            <a href="#"
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Communication/Mail-attachment.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none"
                                        ...
                                        <div class="col-6">
                                            <a href="#"
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Shopping/Box2.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none"
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Communication/Group.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none"
                            ...
                            <div class="d-flex align-items-md-center mb-2 flex-column flex-md-row">
                                <div class="bg-white rounded p-4 d-flex flex-grow-1 flex-sm-grow-0">
                                    ...
                                    <form
                                        ...
                                        <div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                                            <span class="svg-icon svg-icon-lg">
                                                <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Media/Rec.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div
                                                            ...
                                                            <div class="symbol-label">
                                                                <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Devices/Mic.svg-->
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                        version="1.1">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="text-muted font-weight-bold">Code:
                                                                    BR</span>
                                                            </td>
                                                            <td>
                                                                <span
                                        ...
                                        <div class="card-body pt-2">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic/theme/html/demo4/dist/assets/media/stock-600x400/img-17.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic/theme/html/demo4/dist/assets/media/stock-600x400/img-1.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic/theme/html/demo4/dist/assets/media/stock-600x400/img-22.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-10">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic/theme/html/demo4/dist/assets/media/stock-600x400/img-9.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic/theme/html/demo4/dist/assets/media/stock-600x400/img-11.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/006-plurk.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/015-telegram.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/003-puzzle.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/009-hot-air-balloon.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                    <div class="symbol-label">
                                                        <img src="/metronic/theme/html/demo4/dist/assets/media/svg/avatars/001-boy.svg"
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                    <div class="symbol-label">
                                                        <img src="/metronic/theme/html/demo4/dist/assets/media/svg/avatars/028-girl-16.svg"
                                                            class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light">
                                                    <div class="symbol-label">
                                                        <img src="/metronic/theme/html/demo4/dist/assets/media/svg/avatars/024-boy-9.svg"
                                                            class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#" class="symbol symbol-45 symbol-light">
                                                    <div class="symbol-label">
                                                        <img src="/metronic/theme/html/demo4/dist/assets/media/svg/avatars/005-girl-2.svg"
                                                            class="h-75 align-self-end" alt="" />
                                                    </div>
                                                </a>
                                                <!--end::Pic-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-45 symbol-light mr-5">
                                                        <span class="symbol-label">
                                                            <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/014-kickstarter.svg"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body pt-2 pb-0 mt-n3">
                                            <div class="tab-content mt-5" id="myTabTables2">
                                                        ...
                                                        <table class="table table-borderless table-vertical-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <span
                                                                            class="text-muted font-weight-bold">ReactJs,
                                                                            HTML</span>
                                                                    </td>
                                                                    <td class="text-right">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="pl-0">
                                                                        <a href="#"
                                                                            ...
                                                                            Authors</a>
                                                                        <span
                                                                            class="text-muted font-weight-bold d-block">Most
                                                                            Successful</span>
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <span
                                                                            class="text-muted font-weight-bold">Python,
                                                                            MySQL</span>
                                                                    </td>
                                                                    <td class="text-right">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <span
                                                                            class="text-muted font-weight-bold">Laravel,
                                                                            Metronic</span>
                                                                    </td>
                                                                    <td class="text-right">
                                                                ...
                                                                <tr>
                                                                    <td class="pl-0 py-5">
                                                                        <div class="symbol symbol-50 symbol-light mr-2">
                                                                            <span class="symbol-label">
                                                                                <img src="/metronic/theme/html/demo4/dist/assets/media/svg/misc/005-bebo.svg"
                                                                                    class="h-50 align-self-center"
                                                                                    alt="" />
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    <td class="pl-0">
                                                                        <a href="#"
                                                                            ...
                                                                            Customers</a>
                                                                        <span
                                                                            class="text-muted font-weight-bold d-block">Best
                                                                            Customers</span>
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <span
                                                ...
                                                <!--end::Tap pane-->
                                                <!--begin::Tap pane-->
                                                <div class="tab-pane fade show active" id="kt_tab_pane_2_3"
                    ...
                    <div class="quick-search-result">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                    <img src="/metronic/theme/html/demo4/dist/assets/media/svg/files/doc.svg" alt="" />
                                </div>
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                    <img src="/metronic/theme/html/demo4/dist/assets/media/svg/files/pdf.svg" alt="" />
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                    <img src="/metronic/theme/html/demo4/dist/assets/media/svg/files/xml.svg" alt="" />
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                    <a href="#" class="font-weight-bold text-dark text-hover-primary">All Framework
                                        Docs</a>
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                    <img src="/metronic/theme/html/demo4/dist/assets/media/svg/files/csv.svg" alt="" />
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                        ...
                        <div class="mb-10">
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 flex-shrink-0">
                                    <div class="symbol-label"
                                        style="background-image:url('/metronic/theme/html/demo4/dist/assets/media/users/300_20.jpg')">
                                    </div>
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 flex-shrink-0">
                                    <div class="symbol-label"
                                        style="background-image:url('/metronic/theme/html/demo4/dist/assets/media/users/300_15.jpg')">
                                    </div>
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 flex-shrink-0">
                                    <div class="symbol-label"
                                        style="background-image:url('/metronic/theme/html/demo4/dist/assets/media/users/300_12.jpg')">
                                    </div>
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                <div class="symbol symbol-30 flex-shrink-0">
                                    <div class="symbol-label"
                                        style="background-image:url('/metronic/theme/html/demo4/dist/assets/media/users/300_16.jpg')">
                                    </div>
                                </div>
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="d-flex align-items-center flex-grow-1 mb-2">
                                ...
                                <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                    <a href="#" class="font-weight-bold text-dark text-hover-primary">$2900 worth
                                        products sold</a>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('/metronic/theme/html/demo4/dist/assets/media/users/300_21.jpg')">
                    </div>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="/metronic/demo4/custom/apps/user/profile-1/personal-information.html" class="navi-item">
                    <div class="navi-link">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="/metronic/demo4/custom/apps/user/profile-3.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="/metronic/demo4/custom/apps/user/profile-2.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo4/dist/assets/media/svg/icons/Files/Selected-file.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="/metronic/demo4/custom/apps/userprofile-1/overview.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-40 mr-3">
                                            <img alt="Pic"
                                                src="/metronic/theme/html/demo4/dist/assets/media/users/300_12.jpg" />
                                        </div>
                                        <div>
                                            <a href="#"
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-40 ml-3">
                                            <img alt="Pic"
                                                src="/metronic/theme/html/demo4/dist/assets/media/users/300_21.jpg" />
                                        </div>
                                    </div>
                                    <div
    ...
    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
        ...
        <li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary"
                href="/metronic/demo4/builder.html">
                <i class="flaticon2-gear"></i>
            </a>
        </li>
        <!--end::Item-->
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo1.png" alt="" class="w-100" />
                    </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo2.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo3.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo4.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo5.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo6.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo7.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo8.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo9.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo10.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo11.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo12.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo13.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo14.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo15.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo16.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo17.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo18.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo19.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo20.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo21.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo22.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo23.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo24.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo25.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo26.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo27.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo28.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo29.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo4/dist/assets/media/demos/demo30.png" alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                            class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
